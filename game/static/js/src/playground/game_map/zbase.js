class GameMap extends AcGameObject {
    ...
    render() {
        ...
        if(this.playground.players.length > 0 && this.playground.players[0].character != "me"){
            ...
            if(bgm.src != "https://app27.acapp.acwing.com.cn/static/audio/playground/end_bgm.mp3") {
                bgm.src = "https://app27.acapp.acwing.com.cn/static/audio/playground/end_bgm.mp3";
            }
        }
    }
}
